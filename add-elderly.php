...
<head>
    ...
    <title>Add Elderly Entry - GS System</title>
...
<body style="background-color: #f8fafc;">
    <nav class="glass-dark" style="padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center;">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <a href="elderly.php" style="color: white;"><i class="fas fa-arrow-left"></i></a>
            <h2><i class="fas fa-person-cane" style="margin-right:0.5rem;"></i>Add Elderly Entry</h2>
        </div>
    </nav>
    ...
    <div class="container animate-fade" style="max-width: 850px; padding: 2rem;">
        <?php if ($success): ?>
            <div style="background: rgba(16,185,129,0.1); border: 1px solid #10b981; color: #065f46; padding: 1rem 1.5rem; border-radius: 8px; margin-bottom: 1.5rem;">
                <i class="fas fa-check-circle"></i> Elderly entry saved successfully!
            </div>
        <?php endif; ?>

        <div class="glass" style="padding: 2.5rem; border-radius: var(--radius-lg);">
            <form action="api/save-elderly.php" method="POST">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="member_count" placeholder="Number of family members">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Age <span style="color: var(--text-muted); font-size: 0.8rem;">(Required for Elderly auto-flag)</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="person_house_no" placeholder="Person's House Number">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Elder Amount / Notes <span style="color: var(--text-muted); font-size: 0.8rem;">(e.g., 5000)</span></label>
                        <input type="text" name="elder" placeholder="Amount">
                    </div>

                </div>

                <div style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 2rem; border-top: 1px solid #f1f5f9; padding-top: 1.5rem;">
                    <a href="elderly.php" class="btn btn-outline">Cancel</a>
